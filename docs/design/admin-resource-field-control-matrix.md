# Ink Memory Admin 资源字段与表单控件规范

> 文档类型：工程实施强制规范  
> 日期：2026-08-08  
> 状态：已并入 Admin PRD v2.1；字段、控件、数据源和容器决策以本文为准  
...
```mermaid
flowchart LR
  P["Provider Full-screen Form"] --> M["Model Full-screen Form"] --> PR["Pricing Version Full-screen Form"]
