# Ink Memory Admin 字段级 UI 视觉实施规范
...
> 功能依据：`admin-resource-field-control-matrix.md`、`refine-admin-ui-v2-interaction-design.md`；模型与计费骨架：`cc-switch-model-billing-adaptation.md`
