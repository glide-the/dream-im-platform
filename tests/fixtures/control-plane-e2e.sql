...
INSERT INTO platform_users (
  ...
  'user-e2e', 'ink-dream', '101', 'creator@example.test', '测试创作者', 'free', 'active'
);

INSERT INTO billing_accounts (
  id, platform_user_id, available_microusd, reserved_microusd
) VALUES ('account-e2e', 'user-e2e', 9000000, 1000000);
...
INSERT INTO gateway_api_keys (
  ...
  'gateway-key-e2e', 'user-e2e', 'E2E key', 'ink_e2e',
...
INSERT INTO gateway_requests (
  ...
  'request-settlement-failed-e2e', 'user-e2e', 'gateway-key-e2e',
...
INSERT INTO billing_ledger_entries (
  ...
  'ledger-reserve-e2e', 'account-e2e', 'user-e2e',
...
INSERT INTO user_model_permissions (
  ...
  'model-permission-e2e', 'user-e2e', 'model-e2e', true, 30, 100000, 1000000
);
...
INSERT INTO gateway_rate_limits (
  ...
  'user-e2e', 'model-e2e', 'minute', date_trunc('minute', CURRENT_TIMESTAMP), 1, 1000
);
