// [Input] Drizzle PostgreSQL primitives and published migration capability metadata.
// [Output] Typed schema declaration for the cross-service capability ledger.
// [Pos] @ink-memory/db capability contract consumed by independently released services.
// [Sync] 2026-08-21: move the capability schema into the database workspace package.
