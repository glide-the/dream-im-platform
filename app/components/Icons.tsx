...
export function IconTool({ className }: { className?: string }) {
  return (
    ...
    >
      <path d="M14 7l3 3" />
      <path d="M10 3a4 4 0 0 0 3 6l-7 7a2 2 0 1 0 3 3l7-7a4 4 0 0 0 6-3" />
    </svg>
  );
}
...
export function IconUsers({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M16 11c1.7 0 3-1.6 3-3.5S17.7 4 16 4s-3 1.6-3 3.5S14.3 11 16 11z" />
      <path d="M8 12c2.2 0 4-1.8 4-4S10.2 4 8 4 4 5.8 4 8s1.8 4 4 4z" />
      <path d="M2 20c0-2.2 2.5-4 5.5-4h1" />
      <path d="M13 16h1.5c3 0 5.5 1.8 5.5 4" />
    </svg>
  );
}
...
export function IconPaperclip({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M21 12l-8.5 8.5a5 5 0 0 1-7.1-7.1L14 4.8a3.5 3.5 0 0 1 5 5L9.4 19.4" />
    </svg>
  );
}
...
export function IconCamera({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M4 7h4l2-2h4l2 2h4v11a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2z" />
...
export function IconSettings({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M19.4 15a7.9 7.9 0 0 0 .1-2l2.1-1.6-2-3.4-2.5 1a7.8 7.8 0 0 0-1.6-.9l-.4-2.7h-4l-.4 2.7a7.8 7.8 0 0 0-1.6.9l-2.5-1-2 3.4 2.1 1.6a7.9 7.9 0 0 0 .1 2L2.5 16.6l2 3.4 2.5-1a7.8 7.8 0 0 0 1.6.9l.4 2.7h4l.4-2.7a7.8 7.8 0 0 0 1.6-.9l2.5 1 2-3.4z" />
    </svg>
  );
}
