...
export default function AdminUsageDashboard() {
  ...
  const [filters, setFilters] = useState<DashboardFilters>(draft);
  ...
  const users = useList<Record<string, unknown>>({ resource: "platform-users", pagination: { currentPage: 1, pageSize: 100 }, sorters: [{ field: "email", order: "asc" }] });
