...
export default function QuickActionCard({ item, onClick }: QuickActionCardProps) {
  return (
    <button
      ...
      className="group w-full rounded-2xl border border-[var(--neutral-border)] bg-white/90 p-5 text-left shadow-subtle backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md"
    >
      <div className="flex gap-4">
        ...
        <div>
          <h3 className="text-lg font-semibold text-[var(--luxury-charcoal)]">{item.title}</h3>
