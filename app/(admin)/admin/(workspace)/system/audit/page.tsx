...
export default function AuditPage() {
  return <AdminModulePage eyebrow="System and audit / immutable trail" title="审计日志" description="所有管理写操作记录操作者、资源、Request ID、IP 与脱敏前后快照。数据库触发器禁止更新和删除。" status="只追加" tabs={systemTabs}>
