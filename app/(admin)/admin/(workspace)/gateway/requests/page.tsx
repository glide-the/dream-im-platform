...
export default function GatewayRequestsPage() {
  return <AdminModulePage eyebrow="Proxy gateway / request trace" title="请求日志" description="追踪鉴权、预授权、Provider、模型解析、流式状态、Token 与结算终态；不保存完整 Prompt 或响应正文。" status="内容最小化" tabs={gatewayTabs}>
