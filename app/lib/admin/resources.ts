...
const resources: Record<AdminResource, ResourceConfig> = {
  ...
  usage: {
    ...
    defaultSort: "created_at",
    filterFields: ["platform_user_id", "provider_id", "model_id", "email", "provider_code", "model_code", "requested_model", "protocol", "status", "outcome", "error_code"],
  },
  ledger: {
    permission: "billing.read",
