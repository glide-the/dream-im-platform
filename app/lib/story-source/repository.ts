...
const storyResources: Record<StorySourceResource, StoryResourceConfig> = {
  ...
  "story-stories": {
    ...
    select: `s.id, s.identifier, s.title, s.description, s.status,
             ...
             s.episode_count, s.artifact_status,
             s.artifact_manifest_revision, s.script_revision,
             s.artifact_sync_status, s.artifact_indexed_at,
             s.artifact_sync_error_code, s.script_size_bytes,
             (s.artifact_status = 'available') AS artifact_available,
             s.reconcile_version,
    ...
    columns: {
      ...
      artifact_available: "(s.artifact_status = 'available')::text",
