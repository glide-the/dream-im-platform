...
// [Sync] 2026-09-15: validate exact configured service background scopes.
import { z } from "zod";
...
const serviceClientSchema = z.strictObject({
  ...
  backgroundScopes: z.array(z.enum(["capabilities:read", "resource-policy:read", "resource-observer:write", "connectors:sync", "plugins:catalog"])),
});
