...
// [Sync] 2026-09-15: retain Registry107 after the independent Registry108 append.
...
it("preserves Registry106 and appends exactly one Registry107 read", () => {
  expect(dreamOperations).toHaveLength(108); expect(generated107).toEqual(dreamOperations);
