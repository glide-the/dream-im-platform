// [Sync] 2026-09-16: keep this frozen Registry107 segment append-safe through Registry121.
...
it("preserves Registry106 and appends exactly one Registry107 read", () => {
  expect(dreamOperations.length).toBeGreaterThanOrEqual(107); expect(generated107).toEqual(dreamOperations);
