// [Sync] 2026-09-16: keep this frozen Registry109 segment append-safe through Registry121.
...
it("preserves Registry108 and appends exactly one Registry109 atomic write", () => {
  expect(dreamOperations.length).toBeGreaterThanOrEqual(109); expect(generated115).toEqual(dreamOperations);
